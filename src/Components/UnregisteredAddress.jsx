...
const UnregisteredAddress = ({ CIN, onSubmit , addressType}) => {
  ...
  const onFinishAddress = (values) => {
      ...
      console.log("unregistered address",addressData,addressType)
      dispatch(addCompanyOrAddress({
        addressType: 'unregisteredAddress',
        addressData,
      }));
...
export default UnregisteredAddress;
